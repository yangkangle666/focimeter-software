...
struct ImageDiagnostics {
    ...
    int large_scale_raw_candidate_count{0};
    int large_scale_rejected_duplicate_count{0};
    int large_scale_rejected_area_count{0};
    int large_scale_rejected_zero_signal_count{0};
    int large_scale_rejected_border_count{0};
    int large_scale_rejected_shape_count{0};
    double background_intensity{0.0};
    double detection_threshold{0.0};
    double small_scale_detection_threshold{0.0};
    double large_scale_detection_threshold{0.0};
    int top_hat_kernel_pixels{0};
    int small_scale_top_hat_kernel_pixels{0};
    int large_scale_top_hat_kernel_pixels{0};
