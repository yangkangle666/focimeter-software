...
| `multispot_lens_pairs/real_lens_repeat_set_002/` | Three confirmed lenses, one no-lens reference and four stationary repeats per lens | Phase-two blind run; data imported but not yet run |
